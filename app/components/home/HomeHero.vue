<template>
  <section class="relative min-h-[72dvh] overflow-hidden bg-lumia-beige/50 md:min-h-[85vh]">
    <NuxtImg
      src="https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?auto=format&fit=crop&w=2000&q=80"
      alt=""
