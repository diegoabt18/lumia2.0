/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5456beb3f316c18fe8cf352a9967b00a)
// Runtime types generated with workerd@1.20260722.1 2026-07-28 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	NUXT_CATALOG_SOURCE: "mongo";
	...
	NUXT_MONGO_AUTH_URI: string;
	NUXT_MONGO_CATALOG_URI: string;
	NUXT_MONGO_SALES_URI: string;
	NUXT_RESEND_API_KEY: string;
	NUXT_RESEND_FROM: string;
	NUXT_ORDER_NOTIFY_EMAIL: string;
	NUXT_TURNSTILE_SECRET_KEY: string;
	NUXT_PUBLIC_TURNSTILE_SITE_KEY: string;
	NUXT_MP_ACCESS_TOKEN: string;
	NUXT_MP_WEBHOOK_SECRET: string;
	NUXT_PUBLIC_MP_PUBLIC_KEY: string;
	NUXT_ORDER_NUMBER_PREFIX: string;
	NUXT_ORDER_PAYMENT_TTL_HOURS: string;
	NUXT_ORDER_MANUAL_PAYMENT_TTL_HOURS: string;
	NUXT_PUBLIC_STORE_CURRENCY: string;
	NUXT_PUBLIC_STORE_LOCALE: string;
	NUXT_PUBLIC_STORE_TIMEZONE: string;
	NUXT_PUBLIC_STORE_BESTSELLER_TOP_N: string;
	NUXT_PUBLIC_STORE_POPULAR_MIN_UNITS: string;
	NUXT_PUBLIC_CART_CONTINUE_SHOPPING_PATH: string;
	NUXT_PUBLIC_CART_PAGE_NO_INDEX: string;
	NUXT_PUBLIC_AUTH_LOCAL_PROVIDER_ENABLED: string;
	NUXT_PUBLIC_WHATSAPP_PHONE: string;
	NUXT_PUBLIC_PRODUCT_IMAGES_CDN_BASE: string;
	NUXT_PUBLIC_PRODUCT_IMAGE_GALLERY_LAYOUT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_CATALOG_SOURCE" | "NUXT_SITE_URL" | "NUXT_JWT_SECRET" | "NUXT_JWT_REFRESH_SECRET" | "NUXT_GOOGLE_CLIENT_ID" | "NUXT_GOOGLE_CLIENT_SECRET" | "NUXT_MONGO_AUTH_URI" | "NUXT_MONGO_CATALOG_URI" | "NUXT_MONGO_SALES_URI" | "NUXT_RESEND_API_KEY" | "NUXT_RESEND_FROM" | "NUXT_ORDER_NOTIFY_EMAIL" | "NUXT_TURNSTILE_SECRET_KEY" | "NUXT_PUBLIC_TURNSTILE_SITE_KEY" | "NUXT_MP_ACCESS_TOKEN" | "NUXT_MP_WEBHOOK_SECRET" | "NUXT_PUBLIC_MP_PUBLIC_KEY" | "NUXT_ORDER_NUMBER_PREFIX" | "NUXT_ORDER_PAYMENT_TTL_HOURS" | "NUXT_ORDER_MANUAL_PAYMENT_TTL_HOURS" | "NUXT_PUBLIC_STORE_CURRENCY" | "NUXT_PUBLIC_STORE_LOCALE" | "NUXT_PUBLIC_STORE_TIMEZONE" | "NUXT_PUBLIC_STORE_BESTSELLER_TOP_N" | "NUXT_PUBLIC_STORE_POPULAR_MIN_UNITS" | "NUXT_PUBLIC_CART_CONTINUE_SHOPPING_PATH" | "NUXT_PUBLIC_CART_PAGE_NO_INDEX" | "NUXT_PUBLIC_AUTH_LOCAL_PROVIDER_ENABLED" | "NUXT_PUBLIC_WHATSAPP_PHONE" | "NUXT_PUBLIC_PRODUCT_IMAGES_CDN_BASE" | "NUXT_PUBLIC_PRODUCT_IMAGE_GALLERY_LAYOUT">> {}
}
